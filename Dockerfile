...
RUN apt-get update && \
    ...
    echo 'deb http://downloads.skewed.de/apt/jessie jessie universe' >> /etc/apt/sources.list.d/graph-tool.list && \
    echo 'deb-src http://downloads.skewed.de/apt/jessie jessie universe' >> /etc/apt/sources.list.d/graph-tool.list && \
